...
import { Layers, CheckCircle2, FileCheck, Calculator } from "lucide-react"
      ...
      <div className="hidden sm:grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
        ...
        <div className="flex items-center gap-4 rounded-xl border border-outline-variant/30 bg-surface-container-low p-4 transition-all hover:shadow-sm">
          ...
          <div>
            ...
            <p className="mt-0.5 text-xs text-outline truncate max-w-[160px]" title={`${termExamsCount} Term, ${weeklySeriesCount} Weekly`}>
              {termExamsCount} Term, {weeklySeriesCount} Weekly
            </p>
          </div>
        </div>
      </div>
