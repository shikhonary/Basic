    ...
    <div className="mb-10 grid grid-cols-2 gap-4 md:grid-cols-4 md:gap-6">
      ...
      <Card className="rounded-xl border border-outline-variant bg-surface-container-lowest p-0 shadow-xs">
        <CardContent className="p-4 sm:p-6">
          ...
          <p className="font-headline-md text-3xl font-extrabold text-tertiary sm:text-4xl">
            {activeGroupsCount}
          </p>
        </CardContent>
      </Card>
      ...
      <Card className="rounded-xl border border-outline-variant bg-surface-container-lowest p-0 shadow-xs">
        <CardContent className="p-4 sm:p-6">
          ...
          <div className="mt-2 flex items-center gap-2 text-emerald-600">
            ...
            <span className="font-headline-md text-base font-bold sm:text-lg">Active</span>
          </div>
        </CardContent>
      </Card>
    </div>
