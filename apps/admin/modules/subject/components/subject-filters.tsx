...
import { X, RotateCcw, SlidersHorizontal, ArrowUpDown, Filter, Layers, BookOpen } from "lucide-react"
...
export function SubjectFilters({
  ...
  const hasActiveLevel = Boolean(selectedLevel && selectedLevel !== "All")
  ...
  const hasAnyFilter = hasActiveQuery || hasActiveLevel || hasActiveGroup || hasActiveAcademicClassId || hasActiveSort
          ...
          <DrawerContent className="p-6 space-y-5 bg-white border-t border-outline-variant/40">
            <DrawerHeader className="p-0 text-left">
              ...
              <DrawerDescription className="text-xs text-on-surface-variant">
                Select level, group, class mappings, and sorting options to refine subject records.
              </DrawerDescription>
            </DrawerHeader>
